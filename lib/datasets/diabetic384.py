...
# all that's changed from imagenet1k is the name,the mean/std of the dataset, crop size, and resize & crop for transform.compose
def diabetic384(args, distributed=False):
    ...
    normalize = transforms.Normalize(mean=[0.8154, 0.7766, 0.7229], std=[0.229, 0.224, 0.225])
    process = [
